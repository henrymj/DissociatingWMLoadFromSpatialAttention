...
data_path = ['/Users/Gisella/Documents/MATLAB/Projects/Perceptual Grouping/Perceptual Grouping V 7.0 Sequential Balanced/Data/'];

% data_file = ['s',num2str(sub),'_CAS_pilot.vhdr'];
data_file = sprintf('s%02d_PGSB1.vhdr',sub);
