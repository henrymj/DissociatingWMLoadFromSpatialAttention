...
erp.droppedElectrodes = {};  % specificy unwanted electrodes (these are our 2 references)

erp.codes = [11:15,19:23];
...
erp.baseStart = -500;  %%% if using the whole time period, just use -erp.preTime
erp.baseEnd = -100;
