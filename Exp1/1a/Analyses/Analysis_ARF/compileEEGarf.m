...
for i = 1:length(subs)
    ...
    numCond5 = sum(erp.trial.codes'==19 & erp.arf.artifactIndCleaned==0);
    numCond6 = sum(erp.trial.codes'==20 & erp.arf.artifactIndCleaned==0);
    numCond7 = sum(erp.trial.codes'==21 & erp.arf.artifactIndCleaned==0);
    numCond8 = sum(erp.trial.codes'==22 & erp.arf.artifactIndCleaned==0);

    erp.arf.num_per_cond = [numCond1,numCond2,numCond3,numCond4,numCond5,numCond6,numCond7,numCond8];
