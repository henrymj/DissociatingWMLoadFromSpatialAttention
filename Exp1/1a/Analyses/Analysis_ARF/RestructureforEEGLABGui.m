...
dbstop if error
    ...
    % add the eyetracking root to the path!!
...
if nTrialEye ~=nTrialEEG
    ...
    if exist(rName)
        ...
        EEG = pop_importdata('dataformat','matlab','nbchan',nchans,'data',rName,'srate',500,'pnts',2350,'xmin',-.600);
        ...
        EEG.reject(:).rejjp = (erp.arf.blocking | erp.arf.noise | erp.arf.dropout);
