function trial = segment(erp,preTime,postTime,dat)
% Segment data
%
...
% dat: finally, provide the continous data you want segmented
%
% OUTPUTS:
...
codes = erp.codes;                         % grab list of codes of interest
